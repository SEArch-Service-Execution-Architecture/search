...
type PrivateMiddlewareServiceClient interface {
	...
	RegisterApp(ctx context.Context, in *RegisterAppRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RegisterAppResponse], error)
...
func (c *privateMiddlewareServiceClient) RegisterChannel(ctx context.Context, in *RegisterChannelRequest, opts ...grpc.CallOption) (*RegisterChannelResponse, error) {
	...
	err := c.cc.Invoke(ctx, PrivateMiddlewareService_RegisterChannel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *privateMiddlewareServiceClient) RegisterApp(ctx context.Context, in *RegisterAppRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RegisterAppResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &PrivateMiddlewareService_ServiceDesc.Streams[0], PrivateMiddlewareService_RegisterApp_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[RegisterAppRequest, RegisterAppResponse]{ClientStream: stream}
...
type PrivateMiddlewareService_RegisterAppClient = grpc.ServerStreamingClient[RegisterAppResponse]
...
func (c *privateMiddlewareServiceClient) CloseChannel(ctx context.Context, in *CloseChannelRequest, opts ...grpc.CallOption) (*CloseChannelResponse, error) {
	...
	err := c.cc.Invoke(ctx, PrivateMiddlewareService_CloseChannel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *privateMiddlewareServiceClient) AppSend(ctx context.Context, in *AppSendRequest, opts ...grpc.CallOption) (*AppSendResponse, error) {
	...
	err := c.cc.Invoke(ctx, PrivateMiddlewareService_AppSend_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *privateMiddlewareServiceClient) AppRecv(ctx context.Context, in *AppRecvRequest, opts ...grpc.CallOption) (*AppRecvResponse, error) {
	...
	err := c.cc.Invoke(ctx, PrivateMiddlewareService_AppRecv_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PrivateMiddlewareServiceServer interface {
	...
	// This is used by provider services to register their provision contract with the Registry/Broker.
	RegisterApp(*RegisterAppRequest, grpc.ServerStreamingServer[RegisterAppResponse]) error
	// This is used by local app (be it a Service Client or a Service Provider) to close a channel.
...
// UnimplementedPrivateMiddlewareServiceServer must be embedded to have
...
func (UnimplementedPrivateMiddlewareServiceServer) RegisterApp(*RegisterAppRequest, grpc.ServerStreamingServer[RegisterAppResponse]) error {
...
func (UnimplementedPrivateMiddlewareServiceServer) testEmbeddedByValue() {}
...
func RegisterPrivateMiddlewareServiceServer(s grpc.ServiceRegistrar, srv PrivateMiddlewareServiceServer) {
	// If the following call pancis, it indicates UnimplementedPrivateMiddlewareServiceServer was
...
func _PrivateMiddlewareService_RegisterApp_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PrivateMiddlewareServiceServer).RegisterApp(m, &grpc.GenericServerStream[RegisterAppRequest, RegisterAppResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type PrivateMiddlewareService_RegisterAppServer = grpc.ServerStreamingServer[RegisterAppResponse]
...
type PublicMiddlewareServiceClient interface {
	...
	MessageExchange(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[MessageExchangeRequest, MessageExchangeResponse], error)
}
...
func (c *publicMiddlewareServiceClient) InitChannel(ctx context.Context, in *InitChannelRequest, opts ...grpc.CallOption) (*InitChannelResponse, error) {
	...
	err := c.cc.Invoke(ctx, PublicMiddlewareService_InitChannel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicMiddlewareServiceClient) StartChannel(ctx context.Context, in *StartChannelRequest, opts ...grpc.CallOption) (*StartChannelResponse, error) {
	...
	err := c.cc.Invoke(ctx, PublicMiddlewareService_StartChannel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicMiddlewareServiceClient) MessageExchange(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[MessageExchangeRequest, MessageExchangeResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &PublicMiddlewareService_ServiceDesc.Streams[0], PublicMiddlewareService_MessageExchange_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[MessageExchangeRequest, MessageExchangeResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type PublicMiddlewareService_MessageExchangeClient = grpc.ClientStreamingClient[MessageExchangeRequest, MessageExchangeResponse]
...
type PublicMiddlewareServiceServer interface {
	...
	MessageExchange(grpc.ClientStreamingServer[MessageExchangeRequest, MessageExchangeResponse]) error
	mustEmbedUnimplementedPublicMiddlewareServiceServer()
}

// UnimplementedPublicMiddlewareServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedPublicMiddlewareServiceServer) MessageExchange(grpc.ClientStreamingServer[MessageExchangeRequest, MessageExchangeResponse]) error {
...
func (UnimplementedPublicMiddlewareServiceServer) testEmbeddedByValue() {}
...
func RegisterPublicMiddlewareServiceServer(s grpc.ServiceRegistrar, srv PublicMiddlewareServiceServer) {
	// If the following call pancis, it indicates UnimplementedPublicMiddlewareServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _PublicMiddlewareService_MessageExchange_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PublicMiddlewareServiceServer).MessageExchange(&grpc.GenericServerStream[MessageExchangeRequest, MessageExchangeResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type PublicMiddlewareService_MessageExchangeServer = grpc.ClientStreamingServer[MessageExchangeRequest, MessageExchangeResponse]
